...
INSERT INTO tb_processo (numero, cliente_id, descricao, situacao, data, valor, forma_pagamento) VALUES ('PROC-001', 1, 'Abertura de processo de consultoria', 'aguardando juiz', '2025-01-10', 5000.00, 0);
INSERT INTO tb_processo (numero, cliente_id, descricao, situacao, data, valor, forma_pagamento) VALUES ('PROC-002', 1, 'Processo trabalhista', 'contactar cliente', '2025-02-15', 3000.00, 1);
INSERT INTO tb_processo (numero, cliente_id, descricao, situacao, data, valor, forma_pagamento) VALUES ('PROC-003', 2, 'Assessoria jurídica', 'aguardando audiencia', '2025-03-05', 8000.00, 1);
